module Dscp.Core.Foundation.Educator.Block.Instances () where
...
import Dscp.Core.Foundation.Educator.Block.Type (PrivateBlock (..), PrivateBlockBody (..), PrivateBlockHeader (..))
