...
For modules outside current project always use explicit import lists or `qualified` imports.
...
For modules from current project use implicit imports.

Use `stylish-haskell` to sort and tidy up your import lists automatically.
...
As an alternative, you can enable `StrictData` extension
